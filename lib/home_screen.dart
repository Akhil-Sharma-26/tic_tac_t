...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        backgroundColor: const Color.fromARGB(255, 163, 92, 250),
        actions: [
          IconButton(
      ...
      body: Column(
        children: [
          _buildPointsTable(),
          _buildGrid(),
          Text('Roll No:',style: TextStyle(fontSize: 20,color: Colors.black, fontWeight: FontWeight.bold),),
          Text('102______',style: TextStyle(fontSize: 60),),
          _buildTurn(),
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Center(
        child: Text(
          ...
          style: kCustomText(color: Colors.black, fontWeight: FontWeight.w300),
        ),
      ),
    );
  }
